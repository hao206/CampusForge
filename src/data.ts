import { Project, Task, Post, Resource, SkillExchangeOffer, Mentor, AuditLog } from './types';
...
export const INITIAL_MENTORS: Mentor[] = [
  {
    id: 'm1',
    name: 'Dr. Nguyen Duc Minh',
    role: 'UTT Associate Professor in CS',
    avatar: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100&auto=format&fit=crop&q=60',
    bio: 'Over 15 years research experience in artificial intelligence architectures, database optimization and parallel computing.',
    rating: 4.9,
    sessionsBooked: 45,
    skills: ['Machine Learning', 'Big Data', 'Database Design', 'Algorithm Design']
  },
  {
    id: 'm2',
    name: 'Sarah Le (UTT Alumna \'21)',
    role: 'Senior Security Consultant at CyberShield',
    avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&auto=format&fit=crop&q=60',
    bio: 'Graduated top of cyber security department. Passionate about helping current students implement safe web apps, OAuth scopes, and secure hashing.',
    rating: 5.0,
    sessionsBooked: 24,
    skills: ['JWT Token Security', 'Network Hacking prevention', 'PostgreSQL admin']
  },
  {
    id: 'm3',
    name: 'Phan Anh Tuan',
    role: 'Principal Engineer at TechVant VC',
    avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&auto=format&fit=crop&q=60',
    bio: 'Guiding students over system analysis, business model design, seed round presentations, and Cloud native deployments.',
    rating: 4.8,
    sessionsBooked: 18,
    skills: ['System Analysis', 'SaaS product development', 'MySQL databases']
  }
];
